...
from phriky_units.cps_units_checker import CPSUnitsChecker
from phriky_units.unit_error_types import UnitErrorTypes
from phriky_units.unit_error import UnitError
...
class TestPhriky_units(unittest.TestCase):
    ...
    def test_function_return_0(self):
        ...
        if os.path.exists('./tests'):
            dump_file = dump_file[1:]  #REMOVE LEADING .
            dump_file = './tests' + dump_file
