...
// ADD THEN MULTIPLY
// (m /s + m/s) * m
a_geometry_msgs_Accel.linear.x = (a_geometry_msgs_AccelStamped.accel.linear.x + a_geometry_msgs_Accel.linear.x) * a_sensor_msgs_Range.range;
// (m /s + m/s) / m
a_geometry_msgs_Accel.linear.x = (a_geometry_msgs_AccelStamped.accel.linear.x + a_geometry_msgs_Accel.linear.x) / a_sensor_msgs_Range.range;

//(m/s + m) * m/s  MULTIPLE HYPOTHESIS
a_geometry_msgs_Accel.linear.x = (a_geometry_msgs_AccelStamped.accel.linear.x + a_sensor_msgs_Range.range) * a_geometry_msgs_Accel.linear.y;

// UGLIER
a_geometry_msgs_Accel.linear.x = (a_geometry_msgs_AccelStamped.accel.linear.x + a_sensor_msgs_Range.range) / (a_sensor_msgs_Temperature.temperature + a_geometry_msgs_Accel.linear.y);
